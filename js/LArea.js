        ...
        bindEvent: function() {
            ...
            function popupArea(e) {
                ...
                larea_finish.addEventListener('touchstart', function(e) {
                    ...
                    $("#specail_content").html($("#ld_result_"+input.value).html());
                    /*
                    if(input.value == 62){
                        $(".specail_num1").css("display","block");
                        $(".specail_num2").css("display","none");
                        $(".specail_num3").css("display","none");
                    }else if(input.value == 60){
                        $(".specail_num1").css("display","block");
                        $(".specail_num2").css("display","block");
                        $(".specail_num3").css("display","none");
                    }else{
                        $(".specail_num1").css("display","block");
                        $(".specail_num2").css("display","block");
                        $(".specail_num3").css("display","block");
                    }
                    */
                });
            ...
            function areaCtrlInit() {
                ...
                switch (_self.line) {
                    case 1:
                        _self.gearArea.querySelector(".p_area_city").style.flex="0";
                        _self.gearArea.querySelector(".p_area_county").style.flex="0";
                        break;
                    case 2:
                        _self.gearArea.querySelector(".p_area_county").style.flex="0";
                        break;
